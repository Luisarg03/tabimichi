...
import { POST as recommendPOST } from "@/lib/api/routes/recommend";
import { POST as feedbackPOST, GET as feedbackGET } from "@/lib/api/routes/feedback";
import { GET as profileGET, POST as profilePOST } from "@/lib/api/routes/profile";
import { GET as geocodeGET } from "@/lib/api/routes/geocode";
import { GET as photoGET } from "@/lib/api/routes/photo";
import { GET as photosGET } from "@/lib/api/routes/photos";
import { GET as logsGET } from "@/lib/api/routes/logs";
import { geocodeVariants } from "@/lib/api/routes/geocode";
