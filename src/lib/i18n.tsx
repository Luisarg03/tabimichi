...
const es: Dict = {
  ...
  reasons: {
    ...
    mealTime: "Buen momento para comer",
    nightTime: "La noche está en su punto",
    onsenEvening: "Baño de tarde — clásico",
    ...
    established: "Consagrado ({n} reseñas)",
...
const en: Dict = {
  ...
  reasons: {
    ...
    mealTime: "Good time for a meal",
    nightTime: "Night is at its best",
    onsenEvening: "Evening soak — a classic",
    ...
    established: "Established ({n} reviews)",
